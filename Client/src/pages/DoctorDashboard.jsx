...
return formatted;
 ...
 if(loading){
    return <div className='font-bold text-4xl flex flex-col justify-center gap-4 text-black'><div className='text-center'>Loading....</div><div className='text-sm text-center font-light'>Note! if you was logged in before with any other role and get wrong details of your's then please logout first and then try log in again.</div></div>
  }
