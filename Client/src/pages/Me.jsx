...
const Me = () => {
  ...
  if (loading) {
    return <div className='font-bold flex justify-center text-sm font-sans text-black'><div>Loading....</div></div>
  }
      ...
      {Notselected && (
        <>
          ...
          <div className="mt-4 flex justify-center">
            <select onChange={handlefilter} defaultValue={''} className='p-2 rounded-md bg-white text-black font-semibold'>
