        ...
        <table border="0" cellpadding="0" cellspacing="0" width="600" style="background-color: #ffffff; border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
          <tr>
            <td align="center" style="padding: 30px;">
              ...
              <p style="color: #718096; font-size: 14px;">Please use this OTP within the next 5 minutes. If you didn't request this, just ignore this email.</p>
              <!-- ✅ Footer -->
              <hr style="margin: 30px 0; border: none; border-top: 1px solid #e2e8f0;" />
              <p style="font-size: 12px; color: #a0aec0;">&copy; 2025 Doctor Online. All rights reserved.</p>
              <p style="font-size: 12px; color: #a0aec0;">Contact us at <a href="mailto:support@doctoronline.com" style="color: #3182ce;">support@doctoronline.com</a></p>
            </td>
          </tr>
        </table>
      </td>
